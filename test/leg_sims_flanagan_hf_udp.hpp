...
#ifndef kep3_TEST_LEG_SIMS_FLANAGAN_HF_UDP_H
...
struct sf_hf_test_udp {

    mutable kep3::leg::sims_flanagan_hf leg; // Declare leg as a member variable
    ...
    {
        return pagmo::estimate_gradient_h([this](const std::vector<double> &x) { return this->fitness(x); }, x, 1e-8);
    }
