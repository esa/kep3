...
TEST_CASE("expression_factory")
{
    ...
    *ta.get_pars_data() = kep3::CR3BP_EARTH_MOON;
    ...
    C_cfunc(C0, ic, heyoka::kw::pars = {kep3::CR3BP_EARTH_MOON});
    U_cfunc(U0, ic, heyoka::kw::pars = {kep3::CR3BP_EARTH_MOON});
    C_cfunc(Cf, ic, heyoka::kw::pars = {kep3::CR3BP_EARTH_MOON});
