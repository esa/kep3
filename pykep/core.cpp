...
#undef PYKEP3_EXPOSE_PLANET_GETTER
    ...
    lambert_problem
        ...
        .def("get_vs", &kep3::lambert_problem::get_v1)
        .def("get_vf", &kep3::lambert_problem::get_v2)
        .def("get_rs", &kep3::lambert_problem::get_r1)
        .def("get_rf", &kep3::lambert_problem::get_r2)
